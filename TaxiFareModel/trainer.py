...
class Trainer(object):
    ...
    def save_model(self):
        """Save the model into a .joblib format and then upload to GCP"""
        ...
        blob = bucket.blob(f"models/{MODEL_NAME}/{MODEL_VERSION}.joblib")
        blob.upload_from_filename('model.joblib')
        print(colored("model.joblib saved on GCP storage", "green"))
